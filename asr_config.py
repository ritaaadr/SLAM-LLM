...
@dataclass
class ModelConfig:
    file: str = "/home/annaritadero/adellarocca/SLAM-LLM/examples/asr_librispeech/model/slam_model_asr.py:model_factory"
    llm_name: str = "vicuna-7b-v1.5"
    llm_path: str = "/home/annaritadero/adellarocca/SLAM-LLM/models/vicuna-7b-v1.5" #"PATH/to/LLAMA/7B"
    llm_type: str = "decoder_only"
    llm_dim: int = 4096
    encoder_name: Optional[str] = None
    encoder_ds_rate: int = 2
    encoder_path: Optional[str] = "/home/annaritadero/adellarocca/SLAM-LLM/models/hubert_xtralarge.pt"
...
class DataConfig:
    ...
    file: str = "/home/annaritadero/adellarocca/SLAM-LLM/src/slam_llm/datasets/speech_dataset.py:get_speech_dataset"
...
class LogConfig:
    ...
    log_file: str = "/home/annaritadero/adellarocca/SLAM-LLM/test.log"
    log_interval: int = 5
